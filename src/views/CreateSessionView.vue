...
<template>
  <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white shadow-sm rounded-lg border border-gray-100 p-6">
      <h1 class="text-2xl font-bold text-gray-900 mb-6">Create New Session</h1>
      ...
      <form @submit.prevent="createSession" class="space-y-6">
        <div>
          ...
          <input
            ...
            placeholder="e.g. Wednesday Badminton"
          />
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            <label for="courtFee" class="block text-sm font-medium text-gray-700">Court Fee (VND)</label>
            <input
          ...
          <div>
            <label for="shuttleFee" class="block text-sm font-medium text-gray-700">Shuttle Fee (VND)</label>
            <input
